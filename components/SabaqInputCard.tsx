...
export const SabaqInputCard = forwardRef<HTMLDivElement, SabaqInputCardProps>(({
  ...
  return (
    ...
    >
      ...
      <div className={`p-4 md:p-5 border-b transition-colors ${
        isSaved
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-start sm:items-center gap-3">
            ...
            <div>
              ...
              {isSaved && (
                <div className="mt-2 inline-flex items-center gap-2 px-3 py-1 bg-white/90 border border-emerald-200 rounded-lg text-xs font-bold text-emerald-900 shadow-2xs">
            ...
            {isEditingTarget ? (
              ...
              <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200/80 text-emerald-800 px-3 py-1.5 rounded-xl">
                ...
                <button 
                  ...
                  className="text-emerald-600 hover:text-emerald-900 p-0.5 rounded-md hover:bg-emerald-100 transition-colors ml-1 disabled:opacity-40"
      ...
      <div className="p-5 md:p-6 space-y-5">
        ...
        <div className={`p-3.5 bg-amber-50/60 border border-amber-200/80 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 ${isFormDisabled ? 'opacity-60 pointer-events-none' : ''}`}>
          ...
          {noNewMemorization && (
            <div className="flex items-center gap-2 shrink-0">
              ...
              <select
                ...
                className="bg-white border border-amber-300 rounded-lg px-2.5 py-1.5 text-xs font-bold text-gray-900 focus:ring-2 focus:ring-amber-500 outline-none shadow-2xs disabled:bg-gray-100"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          ...
          <div className={`md:col-span-5 bg-gray-50/70 p-4 rounded-xl border border-gray-100 space-y-3 transition-opacity ${noNewMemorization || isFormDisabled ? 'opacity-60 pointer-events-none' : ''}`}>
            <div className="flex flex-wrap items-center justify-between gap-1.5 pb-1 border-b border-gray-200/60">
              ...
              <div className="flex items-center bg-gray-200/80 p-0.5 rounded-lg text-[10px] font-bold">
                <button
                  type="button"
                  disabled={noNewMemorization || isFormDisabled}
                  onClick={() => {
                    setIsMultiSurah(false);
          ...
          <div className={`md:col-span-4 bg-gray-50/70 p-4 rounded-xl border border-gray-100 flex flex-col justify-between space-y-3 ${isFormDisabled ? 'opacity-60' : ''}`}>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input 
                  ...
                  onChange={(e) => {
                    if (noNewMemorization || isFormDisabled) return;
                    const val = e.target.value === '' ? 0 : parseInt(e.target.value, 10);
                    if (!isNaN(val)) {
                      setJumlahBaris(val);
                    }
                  ...
                  className={`w-full border rounded-xl px-3 py-2 text-base font-black outline-none shadow-2xs pr-16 ${
                    noNewMemorization || isFormDisabled
        ...
        <div className="pt-3 border-t border-gray-100">
          ...
          <textarea
            ...
            className="w-full bg-white border border-gray-200 rounded-xl px-3 py-2 text-xs font-medium text-gray-800 focus:ring-2 focus:ring-emerald-500 outline-none resize-none shadow-2xs disabled:bg-gray-100 disabled:text-gray-500"
          />
        </div>
        ...
        <div className="pt-4 border-t border-gray-100 flex flex-col sm:flex-row justify-end items-center gap-3">
          {isSaved && !isEditing ? (
            /* MODE TERSIMPAN: Show "Edit Setoran" & "Lanjut ke Siswa Berikutnya" */
            <>
              <button
                type="button"
                onClick={() => setIsEditing(true)}
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-emerald-600 bg-white hover:bg-emerald-50 text-emerald-800 font-extrabold text-xs flex items-center justify-center gap-2 transition-colors shadow-2xs cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-extrabold text-xs flex items-center justify-center gap-2 transition-all shadow-sm hover:shadow cursor-pointer"
              >
                <span>➡ Lanjut ke Siswa Berikutnya</span>
              </button>
            </>
          ) : (
            /* MODE EDIT / UNSETS: Show "Simpan" & "Simpan & Berikutnya" */
            <>
              {isEditing && (
                <button
                  type="button"
