...
// PINDAHKAN KE SINI (Di luar Class) agar tidak error "Not Defined"
const SDQ_STARTERS = [
  "Al-Baqarah",    // Juz 1
  "Al-Ahqaf",      // Juz 26
...
export class TahfizhEngine {
  ...
  static calculateRange(start: AyahPointer, end: AyahPointer): CalculationResult {
    ...
    // CASE 2: BEDA SURAH
      ...
      // Kita pakai langsung variabel SDQ_STARTERS (tanpa this.) karena ada di luar
